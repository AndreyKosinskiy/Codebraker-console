module ConsoleMenu
  module RegistrationMenu
    class Registration
      def initialize(init:,player_object:,difficult_object:,separator_begin:"",separator_after_name:". - ",separator_after_attempts:" attempts, ",separator_after_hints:" hints.\n")
      ...
      def create_player
        ...
        while !go_to_choose_difficult
          puts 'Please, enter your name: '
          player_name = gets.chomp
          exit_now!(player_name)
          begin
            @init[:gem_player] = @player_object.new(name:player_name)
      ...
      def choose_difficult
        ...
        while !go_to_game
          ...
          if difficult_variant
            @init[:difficult] = @difficult_object.new(difficult_variant:difficult_variant)
            go_to_game = true
          else
